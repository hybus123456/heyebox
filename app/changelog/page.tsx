...
const changelog = [
  {
    ...
    date: "2026-07-22",
    changes: [
      { type: "新增", description: "图片转Base64工具" },
      { type: "新增", description: "随机数生成器" },
      { type: "新增", description: "IP查询工具" },
      { type: "新增", description: "加密解密工具（支持摩斯密码、凯撒、ROT13、维吉尼亚等）" },
    ],
  },
  {
    version: "1.2.2",
  ...
  },
  {
    ...
    date: "2026-07-21",
    changes: [
      { type: "新增", description: "液态玻璃效果" },
      { type: "新增", description: "用户可调节玻璃透明度" },
  ...
  },
  {
    ...
    changes: [
      ...
      { type: "改进", description: "打字测试只保留英文文本" },
    ],
  },
  {
    version: "1.0.2",
  ...
  },
  {
    ...
    date: "2026-07-21",
    changes: [
      { type: "新增", description: "重新设计极简风格Logo" },
      { type: "新增", description: "新增5个工具" },
      { type: "新增", description: "新增3个游戏" },
      { type: "新增", description: "算术验证码防机器人" },
      { type: "改进", description: "首页改为高级灰白配色" },
      { type: "改进", description: "卡片悬停效果优化" },
  ...
  },
  {
    ...
    date: "2026-07-19",
    changes: [
      { type: "新增", description: "新增速算挑战游戏" },
      { type: "新增", description: "新增数字记忆游戏" },
      { type: "新增", description: "新增24点游戏" },
  ...
  },
  {
    ...
    date: "2026-07-19",
    changes: [
      { type: "新增", description: "新增单词配对记忆游戏" },
      { type: "新增", description: "新增完形填空挑战游戏" },
      { type: "新增", description: "新增单词速记挑战游戏" },
  ...
  },
  {
    ...
    date: "2026-07-19",
    changes: [
      { type: "新增", description: "新增6个实用工具" },
      { type: "新增", description: "反馈系统使用SQLite数据库存储" },
    ],
  },
  {
    version: "0.3.0",
    date: "2026-07-19",
    changes: [
      { type: "新增", description: "实现12个在线工具" },
      { type: "新增", description: "集成反应力测试游戏" },
      { type: "新增", description: "集成昆虫记科普游戏" },
      { type: "新增", description: "新增单词拼写挑战游戏" },
  ...
  },
  {
    ...
    changes: [
      ...
      { type: "新增", description: "实现首页Hero区域" },
